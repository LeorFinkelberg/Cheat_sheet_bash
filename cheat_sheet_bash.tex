...
\remark[red]{
Никода не устанавливайте пакеты без предварительного обновления системы! Это может привести к разрушению состояния системы
}
...
\remark[red]{
При удалении пакетов всегда просматривайте список пакетов перед подтверждением. Иначе можно удалить весь рабочий стол из-за зависимостей
}
