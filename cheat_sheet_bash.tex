...
Если заменить оператор перенаправления \verb|<<| на \verb|<<-|, то командная оболочка будет игнорировать начальные символы табуляции во встроенном документе. Благодаря этому во встроенный документ можно добавить отступы для большей удобочитаемости
\begin{lstlisting}[
style = bash,
numbers = none
]
